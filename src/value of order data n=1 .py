    ...
    for r in range(times):
        ...
        for w in W:
            ...
            if empirical_prof > empirical_p:
                ...
                empirical_w=w
            center_prof=center_profit(s, c, xi, eta, w)
            ...
            if both_prof>both_p:
                both_p=both_prof
                both_w=w
        true_profit_em=true_profit(s, c, demand_low, demand_up, mu, sigma, empirical_w)
        true_profit_ce=true_profit(s, c, demand_low, demand_up, mu, sigma, center_w)
        true_profit_or=true_profit(s, c, demand_low, demand_up, mu, sigma, order_w)
        true_profit_de=true_profit(s, c, demand_low, demand_up, mu, sigma, demand_w)
